    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.TextField(verbose_name='Descripción')),
                ('dias_duracion', models.PositiveIntegerField(default=1, verbose_name='Días de Duración')),
                ('noches_duracion', models.PositiveIntegerField(default=0, verbose_name='Noches de Duración')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paquete', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tarifas', to='catalogo.paquete')),
                ('temporada', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tarifas', to='catalogo.temporada')),
            ],
            options={
                'verbose_name': 'Tarifa',
