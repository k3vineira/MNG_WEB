...
CREATE TABLE IF NOT EXISTS `pago` (
    ...
    CONSTRAINT `fk_pago_reserva_id` FOREIGN KEY (`reserva_id`) REFERENCES `reserva` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS `plan_guia` (
    ...
    CONSTRAINT `fk_plan_guia_codigo_paquete` FOREIGN KEY (`codigo_paquete`) REFERENCES `paquete` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
