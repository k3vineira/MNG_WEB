...
FAQS = [
    ...
    {
        "keywords": ["reserva", "reservas", "reservar", "agendar", "apartar"],
    ...
    {
        "keywords": ["pago", "pagos", "pagar", "metodo", "tarjeta", "efectivo", "transferencia"],
    ...
    {
        "keywords": ["mascota", "mascotas", "perro", "perros", "gato", "gatos", "animal", "animales"],
        "answer": "¡Sí! Somos un lugar pet-friendly. Tus mascotas son bienvenidas en la mayoría de nuestras actividades."
    },
    {
        "keywords": ["contacto", "telefono", "celular", "email", "correo", "llamar"],
    ...
    {
        "keywords": ["guia", "guias", "personas", "acompañante", "acompañantes"],
        "answer": "Nuestros tours incluyen guías turísticos certificados que te acompañarán durante toda la experiencia."
    },
    {
        "keywords": ["comida", "comidas", "restaurante", "almuerzo", "desayuno", "cena", "hambre", "alimentacion"],
