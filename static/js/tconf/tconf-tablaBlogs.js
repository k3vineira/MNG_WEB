$(document).ready(function() {
    $('#tablaBlogs').DataTable({
        ...
        language: {
            ...
            sEmptyTable:     "Ninguna publicación disponible en esta tabla",
            sInfo:           "Mostrando registros del _START_ al _END_ de un total de _TOTAL_ publicaciones",
            sInfoEmpty:      "Mostrando registros del 0 al 0 de un total de 0 publicaciones",
